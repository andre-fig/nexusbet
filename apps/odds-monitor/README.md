...
REST GET é a verdade; EventSource recebe invalidações pequenas e reconecta automaticamente. Sync é somente refresh de GETs. Nenhuma métrica de arbitragem/consenso é calculada. Providers são dinâmicos.
