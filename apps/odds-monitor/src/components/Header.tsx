...
import { RefreshCw, Moon, Sun, User, LayoutDashboard, FileText, Layers, ExternalLink } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-40 w-full bg-surface-container-lowest/95 backdrop-blur-md border-b border-outline-variant/30">
      <div className="h-14 w-full px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          >
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-mono text-[11px] text-on-surface-variant/70">v2.4</span>
            </div>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2 py-0.5 rounded bg-surface-container-low border border-outline-variant/30">
            ...
            <span className="font-mono text-[11px] text-on-surface-variant uppercase tracking-wider">prod-us-east-1</span>
          </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Reference Images & HTML link modal button */}
          <button
            onClick={onOpenDirectImages}
            title="Ver imagens de referência & HTML original"
            className="flex items-center gap-1.5 px-2.5 py-1 rounded bg-surface-container-low hover:bg-surface-container border border-outline-variant/40 text-on-surface text-[12px] font-medium transition-colors"
          >
          ...
          >
            ...
            <span className="font-semibold text-[11px] uppercase tracking-wider hidden sm:inline">Sync</span>
          </button>
          ...
          {/* Profile Circle */}
          <div 
            className="w-7 h-7 rounded-full bg-primary-container text-on-primary flex items-center justify-center text-xs font-semibold cursor-pointer"
            title="User Profile: a_figueiredo@icloud.com"
          >
            <User size={15} />
          </div>
        </div>
