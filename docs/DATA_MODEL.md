...
| team_aliases / TeamAlias | esport, alias, canonical_name, evidence, created_at | Abreviação normalizada única por esporte, aprendida apenas de grupo não ambíguo; reutilizada no matching |
